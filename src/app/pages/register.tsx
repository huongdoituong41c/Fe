            ...
            <section className="h-screen">
                <div className="h-full">
                    <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
                        <div className="shrink-1 mb-12 grow-0 basis-auto md:mb-0 md:shrink-0">
                            <img
                                src={Logo}
                                alt="Sample"
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="w-full mx-auto flex justify-center items-center flex-col">
                                    <div className='w-2/3 mt-2'>
                                        ...
                                        {errors.firstName && <span className="text-red-600 flex justify-start pt-2">This field is required.</span>}
                                    </div>
                                    ...
                                    <div className='w-2/3 mt-6'>
                                        ...
                                        {errors.lastName && <span className="text-red-600 flex justify-start pt-2">This field is required.</span>}
                                    </div>
