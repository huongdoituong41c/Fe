    ...
    return (
        <div className='py-20 w-full mx-auto'>
            <div className='w-[1320px] mx-auto'>
                <div className='h-full w-full grid' style={{ 'gridTemplateColumns': "1fr 1fr 386px" }}>
                    <div className='relative col-span-2 mr-4 cursor-pointer rounded-xl'>
                        <img src='https://q-xx.bstatic.com/xdata/images/hotel/max500/383601935.jpg?k=5d11cf03399474c0e756c556150cc422eaea38a356d9324856f972eb733827d0&o=' alt='' className='object-cover rounded-xl w-full h-full aspect-video' />
                    </div>
                ...
                <div className='z-40 mx-auto mt-10 flex w-full justify-between gap-6 rounded-xl px-5'>
                    <div className='w-full'>
                        <div className='tracking-[.103rem] text-[.6875rem] leading-[1.125rem] font-bold uppercase'>65-67, Hai Bà Trưng, Quận 1, Hồ Chí Minh, Việt Nam</div>
                        <div className="mb-4 font-headline text-4.5xl font-bold lg:text-5xl text-[#86B817] mt-2">Icon Saigon - Lifestyle Design</div>
                        <div className="pb-10 leading-6 border-b border-b-[#86B817]">Wander Catskills Creek is a modern sanctuary nestled within the woods and rolling terrain. Featured in the New York Times, this luxury home has floor-to-ceiling sliding glass doors seamlessly merging the interior with the expansive deck and the natural beauty of the surroundings. With bedrooms offering treehouse-like views and top-tier amenities like a private hot tub and state-of-the-art workstations, this retreat is the perfect place for a tranquil escape. </div>
                        ...
                        <div className='relative flex flex-col border-b border-b-[#86B817]'>
                            ...
                            <div className='w-full p-6 h-[250px] border rounded-lg shadow-lg flex space-x-4'>
                                    ...
                                    <div className='w-full h-1/3 border-b border-b-gray-300 justify-between flex'>
                                        <div className='flex-col items-center'>
                                            <div className='flex flex-wrap text-[18px] max-w-[643px] items-center font-semibold leading-[21px] pb-[10px]'>
                                                <h3 className='m-0 text-inherit'>Deluxe Double Room (miễn phí Trà Chiều)</h3>
                                            </div>
                                    ...
                                    <div className='flex w-full'>
                                        <div className='w-2/3 pt-3 border-r'>
                                            ...
                                            <div className='grid grid-cols-3 gap-2 pt-2'>
                                                <span className='text-[14px] font-normal leading-[17px]'>Air conditioner</span>
                                                <span className='text-[14px] font-normal leading-[17px]'>Wood floor</span>
                                                <span className='text-[14px] font-normal leading-[17px]'>Flat screen TV</span>
                                                <span className='text-[14px] font-normal leading-[17px]'>Slipper</span>
                                                <span className='text-[14px] font-normal leading-[17px]'>Cabinet</span>
                                                <span className='text-[14px] font-normal leading-[17px]'>Minibar</span>
                                            </div>
                                        </div>
                                        <div className='w-1/3 text-right flex flex-col pt-3 space-y-3 items-end'>
                                            ...
                                            <span></span>
                                            <span></span>
                                            <span className='text-[20px] font-semibold leading-[24px]'>1.815.067 ₫</span>
                                            <button className='text-white w-[156px] border-none h-11 p-[6px_8px] text-[16px] min-h-[20px] font-semibold rounded-[8px] bg-[#86B817]' onClick={() => setOpenBookingModal(true)}>Book room</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className='w-full p-6 h-[250px] border rounded-lg shadow-lg flex space-x-4 mt-4'>
                                <div className='flex w-[202px] h-full border'>
                                    <img src='https://img.tripi.vn/cdn-cgi/image/width=404,height=304/https://gcs.tripi.vn/hms_prod/photo/img/1621094865395Pp/226137659.jpg' alt='' className='w-full h-full object-cover' />
                                </div>
                                <div className='flex flex-col flex-1 w-full h-full'>
                                    <div className='w-full h-1/3 border-b border-b-gray-300 justify-between flex'>
                                        <div className='flex-col items-center'>
                                            <div className='flex flex-wrap text-[18px] max-w-[643px] items-center font-semibold leading-[21px] pb-[10px]'>
                                                <h3 className='m-0 text-inherit'>Deluxe Twin Room (miễn phí Trà Chiều)</h3>
                                            </div>
                                            <div className='text-[#4A5568] flex items-center text-[14px] font-normal leading-[17px]'>
                                                <div className='cursor-pointer flex items-center pr-6'>
                                                    <FaUserGroup className='mr-2' />
                                    ...
                                    <div className='flex w-full'>
                                        ...
                                        <div className='w-1/3 text-right flex flex-col pt-3 space-y-3 items-end'>
                                            ...
                                            <span></span>
                                            <span></span>
                                            <span className='text-[20px] font-semibold leading-[24px]'>2.135.373 ₫</span>
                                            <button className='text-white w-[156px] border-none h-11 p-[6px_8px] text-[16px] min-h-[20px] font-semibold rounded-[8px] bg-[#86B817]'>Book room</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className='w-full p-6 h-[250px] border rounded-lg shadow-lg flex space-x-4 mt-4 mb-12'>
                                <div className='flex w-[202px] h-full border'>
                                    <img src='https://img.tripi.vn/cdn-cgi/image/width=404,height=304/https://gcs.tripi.vn/hms_prod/photo/img/1621094960360PV/226138325.jpg' alt='' className='w-full h-full object-cover' />
                                </div>
                                <div className='flex flex-col flex-1 w-full h-full'>
                                    <div className='w-full h-1/3 border-b border-b-gray-300 justify-between flex'>
                                        <div className='flex-col items-center'>
                                            <div className='flex flex-wrap text-[18px] max-w-[643px] items-center font-semibold leading-[21px] pb-[10px]'>
                                                <h3 className='m-0 text-inherit'>Icon Signature - Ban công (miễn phí Trà Chiều)</h3>
                                            </div>
                                            <div className='text-[#4A5568] flex items-center text-[14px] font-normal leading-[17px]'>
                                                <div className='cursor-pointer flex items-center pr-6'>
                                                    <FaUserGroup className='mr-2' />
                                    ...
                                    <div className='flex w-full'>
                                        ...
                                        <div className='w-1/3 text-right flex flex-col pt-3 space-y-3 items-end'>
                                            ...
                                            <span></span>
                                            <span></span>
                                            <span className='text-[20px] font-semibold leading-[24px]'>2.562.448 ₫</span>
                                            <button className='text-white w-[156px] border-none h-11 p-[6px_8px] text-[16px] min-h-[20px] font-semibold rounded-[8px] bg-[#86B817] disabled:bg-slate-300' disabled>Book room</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <BookingModal openBookingModal={openBookingModal} setOpenBookingModal={setOpenBookingModal} />
        </div>
    )
}
